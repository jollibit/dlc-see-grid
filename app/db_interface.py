...
class DBInterface:
    ...
    # Robot Interface
    # -----------------------------
    def add_robot(self, x, y, z, name=None, status=None, hall=None, dx=None, dy=None, dz=None, angle=None, timestamp=None, anchor=None):
    ...
    def update_robot(self, robot_id, status=None, x=None, y=None, z=None, dx=None, dy=None, dz=None, angle=None, timestamp=None, anchor=None):
        session: Session = self.session_factory()
        try:
            ...
            if angle is not None: robot.angle = angle
